...
public class UrnikFragment extends Fragment {
  ...
  private static final String TAG = "Urnik";
   ...
   */
  public static UrnikFragment newInstance() {
    return new UrnikFragment();
  }
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View root = inflater.inflate(R.layout.urnik_layout, container, false);
